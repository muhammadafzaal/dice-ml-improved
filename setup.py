...
setuptools.setup(
    ...
    url="https://github.com/muhammadafzaal/dice-ml-improved",
    download_url="https://github.com/muhammadafzaal/dice-ml-improved/archive/first.tar.gz",
    python_requires='>=3.4',
